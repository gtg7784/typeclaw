...
- Bundled skills MUST use the `typeclaw-` prefix. The dreaming subagent treats this prefix as reserved (it refuses to write muscle-memory skills under it to avoid collisions; see `plugins/memory/dreaming.ts:320`).
