...
// `roles.match` / `roles.permissions` are optional virtual paths: absent from a
// bare-`{}` parse (so they never show up in the enumerated default-config
// paths) but classified in FIELD_EFFECTS.
