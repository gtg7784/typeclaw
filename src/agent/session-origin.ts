...
function renderChannelOrigin(
  ...
  lines.push(
    ...
    '  After calling `skip_response`, any `channel_reply`/`channel_send`',
    '  in the same turn will be rejected — commit to silence or commit',
    '  to replying, not both. Do not include secrets or long reasoning',
    '  in the reason; keep it under one sentence.',
