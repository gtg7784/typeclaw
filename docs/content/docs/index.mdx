...
- 💬 **Many inboxes** — [Slack](/docs/reference/slack-bot), [Discord](/docs/reference/discord-bot), [GitHub](/docs/reference/github), [Telegram](/docs/reference/telegram-bot), [KakaoTalk](/docs/reference/kakaotalk), [LINE](/docs/reference/line), and a built-in terminal UI. Same agent, wherever you are.
