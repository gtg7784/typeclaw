...
<Cards>
  ...
  <Card
    ...
    description="Give the agent another inbox — Slack, Discord, Telegram, or GitHub — beyond the one you set up at init."
  />
  <Card
    title="Code reviewer"
...
- 💬 **Many inboxes** — [Slack](/docs/reference/slack-bot), [Discord](/docs/reference/discord-bot), [GitHub](/docs/reference/github), [Telegram](/docs/reference/telegram-bot), [KakaoTalk](/docs/reference/kakaotalk), and a built-in terminal UI. Same agent, wherever you are.
