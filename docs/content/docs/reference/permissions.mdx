...
## Plugin contract permissions

These are declared by plugins to opt into public contribution surfaces. They are **not** granted to any built-in role by default.

| Permission | Declared by               | Effect                                                                                |
| ---------- | ------------------------- | ------------------------------------------------------------------------------------- |
| `mcp`      | plugins with `mcpServers` | required to export plugin-contributed MCP servers; missing it fails plugin validation |
