...
| --------- | ------------------- | --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `owner`   | `[{ kind: 'tui' }]` | `high`          | `channel.respond`, `cron.schedule`, `cron.modify`, `subagent.*`, `security.bypass.low`, `security.bypass.medium`, `security.bypass.high`, plus every plugin-contributed `security.bypass.<guard>` (wildcard expansion) |
| `trusted` | `[]`                | `medium`        | `channel.respond`, `cron.schedule`, `subagent.*`, `security.bypass.low`, `security.bypass.medium`                                                                                                                      |
| `member`  | `[]`                | `low`           | `channel.respond`, `subagent.spawn`, `subagent.cancel`, `subagent.output`, `security.bypass.low`                                                                                                                       |
