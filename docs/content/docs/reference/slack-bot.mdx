...
Transport: **Socket Mode** (no public URL required). Setup walkthrough: [Add a channel](/docs/guides/first-channel).
...
<Callout type="warn" title="reactions:write is required">
  ...
  engage reaction and every `channel_react` call. See the app manifest in [Add a channel](/docs/guides/first-channel)
