...
| Field      | Default | Effect                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `realProc` | `true`  | Mount a real, PID-namespace-scoped `/proc` in the per-tool sandbox so external package CLIs (`bunx`, `bun add <pkg>`, `bun run <pkg-bin>`) work instead of crashing with Bun's `NotDir`. Grants the container `CAP_SYS_ADMIN`; on runtimes where that cap is a no-op (rootless Docker, gVisor, Docker Desktop ECI, AppArmor-enforcing hosts) the sandbox auto-falls-back to a `tmpfs` `/proc` and external package execution is unavailable. Set `false` to skip the `CAP_SYS_ADMIN` grant entirely. See [/internals/sandbox](/docs/internals/sandbox) |
