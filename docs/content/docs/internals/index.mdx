...
- [Todo continuation](/docs/internals/todo-continuation) — the todo tools, durable scope resolution, and the fail-closed auto-continuation engine that resumes interrupted work.
